...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'enableSslOnlyMode' => false, // bool Force connection by SSL for business with PHP Console installed
        'ipMasks' => array(), // array Set IP masks of business that will be allowed to connect to PHP Console: array('192.168.*.*', '127.0.0.1')
